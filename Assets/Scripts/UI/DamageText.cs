...
public class DamageText : MonoBehaviour
{
    ...
    public void SetAndActive(int damage, Vector3 pos, AttackAttribute attackAttribute, bool isCri)
    {
        ...
        text.text = attackAttribute == AttackAttribute.Hill ? "+" + damage.ToString() : damage.ToString();
    ...
    public Color GetAttackAttributeColor(AttackAttribute attackAttribute)
    {
        switch (attackAttribute)
        {
            ...
            case AttackAttribute.Electricity:
                return new Color(0.9019608f, 0.9006814f, 0.4431373f, 0f);
            case AttackAttribute.Hill:
                return new Color(0f, 1f, 0.129231f, 0f);
            default:
                return new Color(1f, 1f, 1f, 0f);
        }
    }
